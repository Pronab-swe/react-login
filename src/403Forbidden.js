...
const ForbiddenPage = ()=>{
   return(
      <Fragment>
            ...
            <svg  x="0px" y="0px" viewBox="0 0 1000 1000" enableBackground="new 0 0 1000 1000"  className="whistle">
            ...
            <h1 className="forbiddenh1">403</h1>
            <h2 className="forbiddenh2">Not this time, access forbidden!</h2>
     </Fragment>
   )
}
